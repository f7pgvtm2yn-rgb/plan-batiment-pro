...
function decorate(){
 ...
 if($('#jwMaterial')&&!$('#rimRule')){
  const p=document.createElement('p');p.id='rimRule';p.className='jw-note';p.textContent='Rive automatique : largeur du mur − 5 cm d’appui. Pour les murs simples de plus de 30 cm, la largeur restante est calculée sans saisie manuelle ; la hauteur suit le plancher au-dessus du mur.';
...
function init(){
 ...
 $('.version').textContent='v0.10.8';document.title='Plan Bâtiment Pro — v0.10.8';
